...
Button::Button(const float x, const float y, const float w, const float h, std::string_view caption, ICommand* command)
...
Button::Button(std::string_view caption, ICommand* command)
